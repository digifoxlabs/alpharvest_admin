    ...
    <div class="mb-6 rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03]">
        <form method="GET" action="{{ route('admin.orders.index') }}" class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="flex items-end gap-3">
                ...
                <a href="{{ route('admin.orders.index') }}" class="text-sm font-medium text-gray-600 dark:text-gray-300">Reset</a>
            </div>
        </form>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full text-left text-sm">
                ...
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="7" class="px-5 py-8 text-center text-gray-500 dark:text-gray-400">No orders found for the selected filters.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
