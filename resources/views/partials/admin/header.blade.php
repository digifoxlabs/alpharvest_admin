...
@php($currentUserAvatar = $currentUser?->profile_photo_url ?: asset('images/admin/src/images/user/owner.jpg'))
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="{{ $currentUserAvatar }}" alt="User" class="h-full w-full object-cover" />
                    </span>

                    <span class="text-theme-sm mr-1 block font-medium">{{ $currentUser?->name ?? 'Admin User' }}</span>
